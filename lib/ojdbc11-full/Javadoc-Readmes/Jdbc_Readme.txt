Oracle JDBC Driver release 23.5.0.24.07 Readme.txt
======================================================

Driver Versions
---------------

These are the driver versions in the 23.5.0.24.07 release:

  - JDBC Thin Driver 23.5.0.24.07
    100% Java client-side JDBC driver for use in client applications,
    middle-tier servers and applets.

  - JDBC OCI Driver 23.5.0.24.07
    Client-side JDBC driver for use on a machine where OCI 23.5.0.24.07
    is installed.

  - JDBC Thin Server-side Driver 23.5.0.24.07
    JDBC driver for use in Java program in the database to access
    remote Oracle databases.

  - JDBC Server-side Internal Driver 23.5.0.24.07
...
In order to use the JDBC Thin Driver 23.5.0.24.07, please add ojdbc8.jar or
